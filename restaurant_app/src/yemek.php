                        ...
                        <div>
                            <div class="card-body o-hidden border-1 shadow mb-4" style="border-radius: 7px;">
                                ...
                                <div class="form-group m-4 mb-2">
                                    <input type="text" class="form-control" id="food_name" name="food_name" placeholder="Yemek Adı" value="<?= select("food",['id' => $food_id])['name'] ?>">
                                </div>
                                <br>
                                <div class="form-group m-4 mt-0">
                                    <input type="hidden" name="food_id" value="<?= $food_id ?>">
                                    <textarea class="form-control" id="description" name="description" placeholder="Yemek Açıklaması"><?= select("food",['id' => $food_id])['description'] ?></textarea>
                                </div>

                                <button class="btn btn-primary m-4 mt-1" style="background-color: #0E3150;" type="submit" name="edit_food">Yemek Düzenle</button>
