                            ...
                            <div class="info">
                                ...
                                if (isset($_SESSION['user_id'])) { // Eğer kullanıcı giriş yapmışsa
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="custom-input" style="text-align: center;" type="number" id="adet" name="adet" min="1" max="100" value="1" required>
                                    </div>
                                    <br><br>
                                    <div class="form-group">
                                        <label for="snot" >Sipariş Notu</label>
                                        <br>
                                        <textarea class="custom-input w-100" type="text" id="snot" name="snot" placeholder="Örneğin: Acısız, az acılı, çok acılı..." required></textarea>
                                    </div>  
                                    <input type="hidden" name="urun_id" value="' . $_GET['urun']. '">
                                    <input type="hidden" name="restoran" value="' . $_GET['restoran'] . '">
                                    <input type="hidden" name="user_id" value="' . $_SESSION['user_id'] . '">

                                        <br><br>
                                        <button class="custom-button" name="add_basket" type="submit">Sepete Ekle</button>';
