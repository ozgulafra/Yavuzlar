...
if (isset($_GET['search'])) {
    $search = $_GET['search'];
    $urunler = searchrestoran($search);
} else {
    $urunler = getallrestorans(); // Tüm ürünleri getir
}
?>
    ...
    <div id="main">
        ...
        <div class="container p-0">
            ...
            <div class="content">
                ...
                <br><br><br>
                <h2 class="text-center">Tüm Restoranlar</h2>
                <hr>
                <?php
                 $totalItems = count($urunler); // Toplam ürün sayısını hesapla
                 echo '<h5 class="d-flex justify-content-end">' . $totalItems . ' adet restoran bulundu.</h5><br>';
                ?>
                <br><br>
                        ...
                        <div class="col-md-6 d-flex flex-column justify-content-center">
                            <div class="text-center text-md-left"> <!-- Küçük ekranlarda ortalanmış, büyük ekranlarda sola hizalı -->
                                ...
                                <div class="item-go mb-3">
                                    <a style="background-color: #051C30; padding:10px; border-radius:7px; color: white;" href="restoran_detay.php?restoran=' . $urun['id'] . '">Ürüne Git</a>
                                </div>
                            </div></div>';
                            echo '<div class="d-flex justify-content-center align-items-center w-100 mt-2"><p style="font-size:15px;">';
                            $restoran_score = getRestaurantScore($urun['id']);
